...
<input id="char_avto" href="javascript:void(0);" value="Введите размер" onfocus="if (value == 'Введите размер') {value =''}" path="<?php echo htmlspecialchars((isset($_REQUEST['par2'])?$_REQUEST['par2']:'')); ?>" city="<?php echo $city; ?>" type="text"  onclick="d($(this))" class="slct2 sin" style="background:url('/image/new_arrow2.png') no-repeat; border: medium none;"  />
...
$foreach_v__count = 0; foreach ($foreach__v as $foreach_v) { ++$foreach_v__count; ?>
	...
	<div id="zhamk" onclick="$('.podt').show();" lo="<?php echo htmlspecialchars((isset($_REQUEST['par2'])?$_REQUEST['par2']:'')); ?>">Добавить заявку</div>
	</div>
	</td>
</tr>
