...
class CParTechPromPost extends CParMain{
    var $city_id;
    static $name_parser = array(
        'techprompost' => 'Техпромпоставка'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.techprompost.ru/images/stories/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 8438645;
    }
