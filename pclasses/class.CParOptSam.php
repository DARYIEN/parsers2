...
class CParOptSam extends CParMain{
    var $city_id;
    static $name_parser = array(
        'alphagroup' => 'АльфаГрупп'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://optsam.ru/?cat=4');
        $link = $parse->find('div.entry-content div h2 a', 0);
        return $link->href;
    }
}