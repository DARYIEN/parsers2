...
class CParRealMetiz extends CParMain{
    var $city_id;
    static $name_parser = array(
        'realmetiz' => 'Реал Метиз'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['sort'] = 'http://realmetiz.ru/netcat_files/82/78/price06.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 11185158;
        $this->author = 'Феликс';
    }
