...
class CParMSServis extends CParMain{
    var $city_id;
    static $name_parser = array(
        'msservis' => 'Металл Строй Сервис'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.mcckuban.ru/prajs_list/');
        $link = $parse->find('p strong a', 0);
        $return['main'] = $link->href;
        $link = $parse->find('div#content p strong strong a', 0);
        $return['profnastil'] = $link->href;
        return $return;
    }
}