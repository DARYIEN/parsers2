...
class CParStalPro extends CParMain{
    var $city_id;
    public  $pages;
    public  $column;
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://metallsb.ru/');
        $this->document_urls['main'] = 'http://185.248.102.77/pricelists/metal100/moskva/StalPRO/StalPRO-All.xlsx';
...
class CParStalProMoscow extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 8151952;
        $this->pages = 'all';
    }
}
class CParStalProKursk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345238;
        $this->pages = 'truba';
        $this->column = 'C';
    }
}
class CParStalProBryansk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345294;
        $this->pages = 'truba';
        $this->column = 'D';
    }
}
class CParStalProSmolensk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345406;
        $this->pages = 'truba';
        $this->column = 'E';
    }
}
class CParStalProVologda extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345519;
        $this->pages = 'truba';
        $this->column = 'G';
    }
}
class CParStalProKirov extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345575;
        $this->pages = 'truba';
        $this->column = 'H';
    }
}
class CParStalProIjevsk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345632;
        $this->pages = 'truba';
        $this->column = 'I';
    }
}
class CParStalProSamara extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12349345;
        $this->pages = 'truba';
        $this->column = 'J';
    }
}
class CParStalProSaratov extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12349401;
        $this->pages = 'truba';
        $this->column = 'K';
    }
}
class CParStalProVoronej extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12349457;
        $this->pages = 'truba';
        $this->column = 'L';
    }
}
class CParStalProSPB extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12616325;
        $this->pages = 'truba';
        $this->column = 'M';
    }
}
class CParStalProNN extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12345463;
        $this->pages = 'truba';
        $this->column = 'N';
    }
}
class CParStalProVolgograd extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12616537;
        $this->pages = 'truba';
        $this->column = 'O';
    }
}
class CParStalProRostov extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12616972;
        $this->pages = 'truba';
        $this->column = 'P';
    }
}
class CParStalProAssTrahan extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12617207;
        $this->pages = 'truba';
        $this->column = 'Q';
    }
}
class CParStalStavropol extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12617411;
        $this->pages = 'truba';
        $this->column = 'R';
    }
}
class CParStalProKrasnodar extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12617617;
        $this->pages = 'truba';
        $this->column = 'S';
    }
}
class CParStalProBelgorod extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12617827;
        $this->pages = 'truba';
        $this->column = 'T';
    }
}
class CParStalProAssPyatigorsk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12616755;
        $this->pages = 'truba';
        $this->column = 'U';
    }
}
class CParStalProPenza extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12618234;
        $this->pages = 'truba';
        $this->column = 'V';
    }
}
class CParStalProSaransk extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12618438;
        $this->pages = 'truba';
        $this->column = 'X';
    }
}
class CParStalProTula extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12349514;
        $this->pages = 'truba';
        $this->column = 'B';
    }
}
class CParStalProAssKaluga extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12349570;
        $this->pages = 'truba';
        $this->column = 'B';
    }
}
class CParStalProAssPerm extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 12618031;
        $this->pages = 'truba';
        $this->column = 'W';
    }
}
class CParStalProVelikyNov extends CParStalPro{
    function __construct(){
        parent::__construct();
        $this->price_id = 1;
        $this->pages = 'truba';
