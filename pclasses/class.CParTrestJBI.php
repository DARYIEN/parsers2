...
class CParTrestJBI extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        $parse = file_get_html('http://trestgbi.ru/prays_list');
        $links['main'] = trim('http://trestgbi.ru'.$parse->find('div.lc a', 0)->href);
        //p($links);
        return $links;
    }
}