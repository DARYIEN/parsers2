 ...
 * Time: 16:57
 */
class CParAjaxCompany extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ajaxcompany' => 'Компания Аякс'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://company-ajax.com.ua/uploadfiles/ckfinder/files/gosts/pipes/price_august.xls';
        $this->dual_cost = true;
        $this->price_id = 11185167;
        $this->author = 'Феликс';
    }
