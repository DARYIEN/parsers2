...
class CParStroyHolding extends CParMain{
    var $city_id;
    static $name_parser = array(
        'StroyHolding' => 'StroyHolding'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls = $this->getUrl('http://stroyholding.ru/prajs/');
        $this->document_urls['main'] = 'http://stroyholding.ru/filemanager/download/9143';
