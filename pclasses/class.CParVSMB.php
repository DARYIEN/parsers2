...
class CParVSMB extends CParMain{
    var $city_id;
    static $name_parser = array(
        'vsmb' => 'Восточно-Сибирская металлобаза (ВСМБ)'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://vsmetall.ru/data/921/24.01.2014_dlya_klientov.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10683460;
    }
