...
class CParStalPromRostov extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalprom' => 'Стальпром Ростов'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.stalprom.com/upload/prise.xls';
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    //p($this->filter['horizontal']['to']['numeric']);
                    ...
                    if(in_array($num_row, array(28 - $this->filter['cost2']))){
