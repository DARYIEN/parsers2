...
class CParTdstm extends CParMain{
    var $city_id;
    static $name_parser = array(
        'steelmont' => 'Сталь Монтаж'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://tdstm.com/prices/');
        $link = $parse->find('div.center_cont div.default_text a', 0);
        return 'http://tdstm.com'.$link->href;
    }
}