...
class CParNevMet extends CParMain{
    var $city_id;
    static $name_parser = array(
        'nevmet' => 'Невский Металл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['sort'] = 'http://www.nevmet.ru/files/sort.xls';
        $this->document_urls['truba'] = 'http://www.nevmet.ru/files/truba.xls';
        $this->document_urls['list'] = 'http://www.nevmet.ru/files/list.xls';
        $this->document_urls['setka'] = 'http://www.nevmet.ru/files/setka.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11185171;
        $this->author = 'Феликс';
    }
            ...
            switch($key){
                ...
                case 'truba':
                    ...
                    $this->filter =  array(
                        ...
                        'coef' => 1,
                        'end' => '',
                        'header' => 'ТРУБА ПРОФИЛЬНАЯ ГОСТ 8639-82, 8645-68, 30245-2003',
                        'beginOfPrice' => 0,
                        'fake' => '',
                        'skleyka' => false,
                        'dualheader'=>true,
                ...
                case 'list':
                    ...
                    $this->filter =  array(
                        ...
                        'coef' => 1,
                        'end' => '',
                        'header' => 'ЛИСТ ГОРЯЧЕКАТАНЫЙ	ГОСТ 19903-74, ст3 ',
                        'beginOfPrice' => 0,
                        'fake' => '',
                        'skleyka' => false,
                        'dualheader'=>true,
                    ...
                    $this->filter =  array(
                        ...
                        'coef' => 1,
                        'end' => '',
                        'header' => 'ЛИСТ ОЦИНКОВАННЫЙ ГОСТ 19904-90, 08пс	',
                        'beginOfPrice' => 0,
                        'fake' => '',
                        'skleyka' => false,
                        'dualheader'=>true,
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => preg_replace('/ø/iu','',preg_replace('/\?/iu','', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ', $this->filter['fake'].' '.$name.' '.$this->filter['end'])))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
