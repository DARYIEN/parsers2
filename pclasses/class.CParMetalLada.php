...
class CParMetalLada extends CParMain{
    var $city_id;
...
class CParMetalLadaTollatti extends CParMetalLada{
    function __construct(){
        parent::__construct();
        $this->price_id = 13854329;
    }
}