...
class CParCapInvest extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['trubastal'] = 'http://cap-invest.ru/price/%D1%82%D1%80%D1%83%D0%B1%D1%8B_%D1%81%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5.xls';
        $this->document_urls['trubabu'] = 'http://cap-invest.ru/price/%D1%82%D1%80%D1%83%D0%B1%D1%8B_%D0%B1.%D1%83..xls';
        $this->document_urls['arm'] = 'http://cap-invest.ru/price/%D0%BC%D0%B5%D1%82%D0%B0%D0%BB%D0%BB%D0%BE%D0%BF%D1%80%D0%BE%D0%BA%D0%B0%D1%82.xls';
        $this->document_urls['chugun'] = 'http://cap-invest.ru/price/%D1%82%D1%80%D1%83%D0%B1%D1%8B_%D1%87%D1%83%D0%B3%D1%83%D0%BD.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 10446079;
    }
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => preg_replace('/"/iu','',preg_replace('/Ǿ/iu','',preg_replace('/ø/iu','',preg_replace('/\?/iu','', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ',trim($header.' '.$treeString.' '.$name.' '.$this->filter['end']))))))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
