...
class CParMuromArmSnab extends CParMain{
    var $city_id;
    static $name_parser = array(
        'muromarmsnab' => 'МуромАрмСнаб'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://www.muromarmsnab.ru/price/Price-list.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11487227;
    }
