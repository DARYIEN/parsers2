...
class CParSPKChelyabinsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spkchelyabinsk' => 'СПК-Челябинск'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.spk.ru/price/spk-chel/_m_/11222/_p_/file';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-chel/_m_/12353/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267632;
        $this->author = 'Михаил';
    }
