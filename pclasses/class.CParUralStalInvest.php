...
class CParUralStalInvest extends CParMain{
    var $city_id;
    static $name_parser = array(
        'usi' => 'Урал Сталь Инвест'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.tkuralsteel.ru/prais.htm');
        $link = $parse->find('div.maintext ul li a', 0);
        return 'http://www.tkuralsteel.ru'.str_replace('..','',$link->href);
    }
}