...
class CParStroyZhelezoBeton extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stroyzhelezobeton' => 'Стройжелезобетон'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.szb.ru/prices/kirpich.xls';
        $this->document_urls['gbi'] = 'http://www.szb.ru/prices/gbi.xls';
        $this->document_urls['bloki'] = 'http://www.szb.ru/prices/bloki.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 922999;
        $this->author = 'Михаил';
       // $this->iconv =false;
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(count($rows) == 1 && $this->filter['horizontal']['from']['numeric'] == $num_row && $this->filter['header']){
