...
class CParRemontDostavka extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->dual_cost = true;
        $this->author = 'Михаил';
        $this->document_urls = array(   'http://www.remont-dostavka.ru/page/prais_list/',
                                    );
    ...
    function documentParsing($path){
        ...
        $tables = $parse->find('table.pricelist');
//        if(!empty($headers)){
