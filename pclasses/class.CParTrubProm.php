...
class CParTrubProm extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://www.trub-prom.com/trubyi-prays-nalichie')->find('body',0)->innertext, $out);
        $links['main']='http://www.trub-prom.com'.$out[0][0];
