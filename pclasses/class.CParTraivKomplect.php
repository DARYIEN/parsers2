...
class CParTraivKomplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'traivkomplect' => 'Трайв-Комплект'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://traiv-komplekt.ru/price-zip/prais2013.xlsx';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11004735;
    }
