...
class CParUralMetallEnergo extends CParMain{
    var $city_id;
    static $name_parser = array(
        'uralmetallenergo' => 'УралМеталлЭнерго'
    );
    public $items = array();
    function start(){
...
class CParUralMetallEnergoMoscow extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13015367;
    }
}
class CParUralMetallEnergoEBurg extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13016152;
    }
}
class CParUralMetallEnergoUfa extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13016941;
    }
}
class CParUralMetallEnergoNN extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13017354;
    }
}
class CParUralMetallEnergoSamara extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13018512;
    }
}
class CParUralMetallEnergoTumen extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13019293;
    }
}
class CParUralMetallEnergoKazan extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13020084;
    }
}
class CParUralMetallEnergoTagil extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13066774;
    }
}
class CParUralMetallEnergoMagnitogorsk extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13067570;
    }
}
class CParUralMetallEnergoOrenburg extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13068917;
    }
}
class CParUralMetallEnergoPerm extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13332748;
    }
}
class CParUralMetallEnergoNabChelny extends CParUralMetallEnergo{
    function __construct(){
        parent::__construct();
        $this->price_id = 13352426;
    }
}
