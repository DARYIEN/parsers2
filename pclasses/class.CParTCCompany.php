...
class CParSTCompany extends CParMain{
    var $city_id;
    static $name_parser = array(
        'STcompany' => 'Компания СТ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://st-rostov.ru/netcat_files/2293_4.xlsx';
