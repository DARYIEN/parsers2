...
class CParMetallSnabMoscow extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metgart.ru/d/770222/d/metallsnab-price.xls';
...
class CParMetallSnabEkb extends CParMetallSnabMoscow{
    function __construct(){
        parent::__construct();
        $this->price_id = 11499210;
    }
}
class CParMetallSnabVlad extends CParMetallSnabMoscow{
    function __construct(){
        parent::__construct();
        $this->price_id = 11499212;
    }
}