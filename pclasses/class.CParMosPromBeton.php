...
class CParMosPromBeton extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mosprombeton' => 'mosprombeton'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.avtomonolitstroy.ru/prace.xls';
