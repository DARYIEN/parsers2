...
class CParIPKuzminihJuliyaPavlovna extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ipkuzminihjuliyapavlovna' => 'ИП Кузьминых Юлия Павловна'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://setka66.ru/assets/template/content/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11782512;
        $this->author = 'Михаил';
    }
