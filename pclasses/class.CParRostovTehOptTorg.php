...
class CParRostovTehOptTorg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'rtot' => 'РостовТехОптТорг'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://rtot.net/assets/files/pricelist_metall.xls';
