...
class CParProfStroyMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ProfStroyMetall' => 'ПСМ-Профстройметалл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://www.spbmetall.spb.ru/');
