...
class CParAlbatros extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://albatrosspb.ru/price.xls';
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(in_array(trim($row), array('Цена (руб.) за 1000 шт.'))){
                        $this->filter['end'] = 'за 1000 шт.';
                    }
                    if(in_array(trim($row), array('Цена(руб.) за 1 комплект(2шт.)'))){
                        $this->filter['end'] = 'за 1 комплект(2шт.)';
                    }
                    if(in_array(trim($row), array('Цена за 1 шт. руб.'))){
                        $this->filter['end'] = 'за 1 шт.';
                    }
