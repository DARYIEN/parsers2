 ...
 * Time: 12:44
 */
class CParCombaer extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    var $company_name;
    public $temp = array();
    public $stringForFind = 'tbody tr td table tbody tr td table tbody tr';
    ...
    function __construct(){
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_url = 'http://www.kombaer.ru/?p=2';
        $this->price_id = 11468676;
        $this->iconv = true;
    }
        ...
        if(!empty($table)){
            foreach($table as $tr){
                ...
                foreach($tr->find('td') as $td){
                    //p($span->innertext);
                    ;
                    $temp[] =  trim(preg_replace('/&nbsp;/', '', iconv('cp1251','utf-8',$td->plaintext)));
                }
                $this->temp[] = $temp;
            }
        }
