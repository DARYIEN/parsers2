...
class CParEVRASNijnivartovsk extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.emural.ru/files/0/49250631354705615.xls';
        $this->price_id = 10663000;
        //$this->coef = 1000;
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($num_row == $this->filter['horizontal']['from']['numeric']){
                        $header2 = str_replace('Двутавр','',$row);
                        $name = $header2;
                        continue;
                    }
