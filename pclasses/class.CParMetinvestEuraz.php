...
class CParMetinvestEuraz extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metinvesteuraz' => 'Метинвест Евразия'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://sales.metinvestholding.com/upload/sales/report/1/price_eurasia02102014.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11487360;
    }
