...
class CParRosMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'rosmetall' => 'Российский Металл Уфа'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.rosmtl.ru/index/price/1/');
        $link = $parse->find('div#center_main table tbody tr td a.black2', 0);
        return str_replace(' ','%20','http://www.rosmtl.ru/'.$link->href);
    }
}