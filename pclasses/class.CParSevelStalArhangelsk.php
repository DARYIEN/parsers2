...
class CParSevelStalArhangelsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'sevelstalarhangelsk' => 'Северсталь-Инвест'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://invest.severstal.com/files/413/price_Arhangelsk%2028.01.14.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10683489;
    }
