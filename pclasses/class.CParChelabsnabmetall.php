...
class CParChelabsnabmetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'chelabsnabmetall' => 'Челябснабметалл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metal-74.ru/upload/price.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12284457;
        $this->author = 'Михаил';
    }
