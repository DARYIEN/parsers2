...
class CParMosglavsnabMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mosglavsnabmetall' => 'Мосглавснаб-металл'
    );
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.mosglavsnab.ru/prices.html');
        $links = 'http://www.mosglavsnab.ru'.$parse->find('div#main div#text p a', 0)->href;
        return str_replace(' ','%20',$links);
    }
}