...
class CParMetallMarket extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metallmarket' => 'МеталлМаркет'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://metmarkt.ru/d/740753/d/metallmarket-price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10947273;
    }
