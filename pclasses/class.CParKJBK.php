...
class CParKJBK extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kjbk' => 'Комбинат железобетонных конструкций'
    );
    public $items = array();
    function start(){
