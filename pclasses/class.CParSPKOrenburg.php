...
class CParSPKOrenburg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spkorenburg' => 'СПК-Оренбург'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['nerj'] = 'http://www.spk.ru/price/spk-oren/_m_/12272/_p_/file';
        $this->document_urls['prof'] = 'http://www.spk.ru/price/spk-oren/_m_/9183/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267647;
        $this->author = 'Михаил';
    }
