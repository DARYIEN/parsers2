...
class CParMetallocentrSpb extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metallocentrspb' => 'МеталлоЦентр'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metallocentr.net/rokdownloads/metalloprokat.xls';
