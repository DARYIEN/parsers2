...
class CParKazpromAstana extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.kazprom.biz/flbdup/price/Price_04.03.2014.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 7695182;
        $this->parameters['range'] = array('A','C','E','G');
        $this->parameters['begin'] = 11;
        $this->parameters['number_sheet'] = 0;
    ...
    function processParsing(){
        foreach($this->document_list as $path){
            $this->filter =  array(
                ...
                'dualheader'=>false,
                'horizontal' => array(
                    'to' => column($this->parameters['range'][1]),
                    'from' => column($this->parameters['range'][0])),
                'vertical' => array(
                    'to' => array(
                        'numeric' => null),
                    'from' => array(
                        'numeric' => $this->parameters['begin']))
            );
            $this->filter_subset = new MyReadFilter($this->filter);
            $this->head_non = true;
            $this->documentLoad($path);
            $this->sheet = $this->objPHPExcel->getSheet($this->parameters['number_sheet'])->toArray();
            ...
            $this->filter =  array(
                ...
                'dualheader'=>false,
                'horizontal' => array(
                    'to' => column($this->parameters['range'][3]),
                    'from' => column($this->parameters['range'][2])),
                'vertical' => array(
                    'to' => array(
                        'numeric' => null),
                    'from' => array(
...
class CParKazpromPavlodar extends CParKazpromAstana{
    function __construct(){
        parent::__construct();
        $this->price_id = 7694705;
        $this->parameters['begin'] = 10;
        $this->parameters['number_sheet'] = 1;
    }
}
class CParKazpromShimkent extends CParKazpromAstana{
    function __construct(){
        parent::__construct();
        $this->price_id = 7736252;
        $this->parameters['begin'] = 10;
        $this->parameters['number_sheet'] = 2;
    }
}
class CParKazpromAktyubinsk extends CParKazpromAstana{
    function __construct(){
        parent::__construct();
        $this->price_id = 10996743;
        $this->parameters['begin'] = 10;
        $this->parameters['number_sheet'] = 3;
    }
}