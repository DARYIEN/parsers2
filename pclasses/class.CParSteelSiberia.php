...
class CParSteelSiberia extends CParMain{
    var $city_id;
    static $name_parser = array(
        'steelsiberia' => 'Стали Сибири Барнаул'
    );
    public $items = array();
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://xn----7sbe0abbas4cceh.xn--p1ai/images/downloads/Price-list.xls';
    ...
    public function getUrl(){
        $parse = file_get_html('http://xn----7sbe0abbas4cceh.xn--p1ai/прайс-лист');
        $link = $parse->find('div.art-article div.phocadownloadfile32 a', 0);
        return 'http://xn----7sbe0abbas4cceh.xn--p1ai'.$link->href;
    }
}