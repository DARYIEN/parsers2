...
class CParNNK extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://www.nnkholding.ru/e107_files/public/Price_NNK_Holding.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 8471105;
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(in_array($row, array('шт',))){
                        $this->filter['end']='тыс.шт';
                        $this->filter['coef']=1000;
                        continue;
                    }
                    if(in_array($row, array('упак', 'м',))){
                        $this->filter['end']='';
                        $this->filter['coef']=1;
                        continue;
                    }
