...
class CParPervoyaOcheredStroitelstva extends CParMain{
    var $city_id;
    static $name_parser = array(
        'pervoyaocheredstroitelstva' => 'Первая Очередь Строительства'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $i=1;
        while($i<=30){
            if($i<10)$this->document_urls[] = 'http://6427366.ru/prices/0'.$i.'.xls';
            if($i>=10)$this->document_urls[] = 'http://6427366.ru/prices/'.$i.'.xls';
            $i++;
        }
