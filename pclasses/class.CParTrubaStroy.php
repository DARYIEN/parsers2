...
class CParTrubaStroy extends CParMain{
    var $city_id;
    static $name_parser = array(
        'trubastroy' => 'Трубастрой'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.truba-stroy.ru/img/file/prays_list_30.05.13.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 8855997;
    }
