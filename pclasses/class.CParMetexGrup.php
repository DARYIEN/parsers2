...
class CParMetexGrup extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metexgrup' => 'Метэкс Групп'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.metexgroup.ru/apanel/images/image/file/PRICE170214.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 10759811;
    }
