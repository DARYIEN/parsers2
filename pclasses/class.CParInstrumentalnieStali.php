...
class CParInstrumentalnieStali extends CParMain{
    var $city_id;
    static $name_parser = array(
        'instrumentalniestali' => 'ИНСТРУМЕНТАЛЬНЫЕ СТАЛИ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://instali.ru/price.xls';
