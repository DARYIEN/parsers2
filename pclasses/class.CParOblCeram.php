...
class CParOblCeram extends CParMain{
    var $city_id;
    static $name_parser = array(
        'oblceram' => 'Областная Керамика'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%9A%D0%B8%D1%80%D0%BF%D0%B8%D1%87%20%D1%80%D0%B0%D0%B1%D0%BE%D1%87%D0%B8%D0%B9.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%9A%D0%B8%D1%80%D0%BF%D0%B8%D1%87%20%D0%BB%D0%B8%D1%86%D0%B5%D0%B2%D0%BE%D0%B9.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%91%D0%BB%D0%BE%D0%BA%D0%B8.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%96%D0%91%D0%98.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%A1%D0%BC%D0%B5%D1%81%D0%B8.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%93%D0%B8%D0%BF%D1%81%D0%BE%D0%B2%D1%8B%D0%B5%20%D0%BF%D0%B5%D1%80%D0%B5%D0%B3%D0%BE%D1%80%D0%BE%D0%B4%D0%BA%D0%B8.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%9A%D1%80%D0%BE%D0%B2%D0%BB%D1%8F.xls';
        $this->document_urls[] = 'http://obl-ceram.ru/price/%D0%A2%D0%B5%D0%BF%D0%BB%D0%BE%D0%B8%D0%B7%D0%BE%D0%BB%D1%8F%D1%86%D0%B8%D1%8F.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 99929999199;
        $this->author = 'Михаил';
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(count($rows) == 1 && $this->filter['horizontal']['from']['numeric'] == $num_row){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => preg_replace('/Ǿ/iu','',preg_replace('/\?/iu','', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ',trim(iconv ('CP1251','UTF-8',iconv ('UTF-8','CP1252',$header.' '.$treeString.' '.$name)).' '.$this->filter['end']))))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
