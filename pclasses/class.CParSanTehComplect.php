...
class CParSanTehComplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'santehcomplect' => 'Сантехкомплект'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['metiz'] = 'http://www.santech.ru/pics/versions/1priceList.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11074523;
        $this->author = 'Михаил';
    }
    ...
    function processParsing(){
        foreach($this->document_list as $key => $path){
            if($key == 'metiz'){
                $this->filter =  array(
                    'propusk' => array($this->n('B'),$this->n('N'),),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'end' => '',
