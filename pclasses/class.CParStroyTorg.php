...
class CParStroyTorg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'StroyTorg' => 'CParStroyTorg'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls = $this->getUrl('http://stroytorg.org/');
        $this->document_urls['main'] = 'http://stroytorg.org/pricelist.xlsx';
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для водоснабжения ПЭ100 SDR26 (PN 6,3)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для водоснабжения ПЭ100 SDR21 (PN 8,0)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для водоснабжения ПЭ100 SDR17 (PN 10)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для водоснабжения ПЭ100 SDR13,6 (PN 12,5)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для водоснабжения ПЭ100 SDR11 (PN 16)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFGHIJK'),
                    'cost1' => false,
                    'cost2' => 9,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для газоснабжения ПЭ 80 SDR 17,6',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('BCFGHIJK'),
                    'cost1' => false,
                    'cost2' => 7,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для газоснабжения ПЭ 80 SDR 11',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('BCDEHIJK'),
                    'cost1' => false,
                    'cost2' => 5,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для газоснабжения ПЭ 80 SDR 13,6',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 1,
                    'coef' => 1,
                    'begin' => 'Полиэтиленовые трубы для газоснабжения ПЭ 80 SDR 9',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
