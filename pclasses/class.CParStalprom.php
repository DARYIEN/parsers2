...
class CParStalprom extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://zaostalprom.ru/')->find('body',0)->innertext, $out);
        $links['main']=$out[0][0];
       // p($out);
