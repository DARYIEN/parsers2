...
class CParStalMash extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://yaruse.ru/files/Metalloprokat_ot_GP_Stalmash_-_predlozhenie_[otkryt_dlya_prosmotra,_sohranit].xls';
