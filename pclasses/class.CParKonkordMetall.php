...
class CParKonkordMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'konkordmetall' => 'КонкордМеталл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.c-met.ru/media/uploads/price-truba.xls';
        $this->document_urls['sort'] = 'http://www.c-met.ru/media/uploads/price-sort.xls';
        $this->document_urls['nerj'] = 'http://www.c-met.ru/media/uploads/nerjaveyka-price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11520450;
        $this->author = 'Михаил';
    }
