...
class CParRusMetKrasnodar extends CParMain{
    var $city_id;
    static $name_parser = array(
        'rusmet' => 'Русмет Краснодар'
    );
    public $items = array();
