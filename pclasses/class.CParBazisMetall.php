...
class CParBazisMetall extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_url = 'http://bazis-metall.ru/images/praise.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 10000883;
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(in_array($num_row, array($this->filter['horizontal']['to']['numeric']-1,$this->filter['horizontal']['to']['numeric']-2,$this->filter['horizontal']['to']['numeric']-3,$this->filter['horizontal']['to']['numeric']-4,))){
                        continue;
                    }
                    if(in_array($row, array('Наименование продукции', 'шт'))){
                        continue 2;
                    }
                    $name .= ' '.$row;
                }
