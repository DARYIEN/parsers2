...
class CParStalInProfil extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalinprofil' => 'Сталь Ин Профиль'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://stalinpro.ru/prays-list')->find('body',0)->innertext, $out);
        $links['main']='http://stalinpro.ru'.$out[0][0];
       // p($out);
