...
class CParGlavMetResurs extends CParMain{
    var $city_id;
    static $name_parser = array(
        'glavmetresurs' => 'ГлавМетРесурс'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.glavmetresource.ru/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 10094654;
    }
