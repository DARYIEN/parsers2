...
class CParPassat extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_name = current(array_keys(self::$name_parser)).'_Moscow_'.date('d-m-Y', time()).'_'.time().'.csv';
        $this->document_urls = $this->getUrl('http://www.allmetal.ru/ru/price');
        //$this->document_urls['main'] = 'http://www.allmetal.ru/upload/files/price_PASSAT_list.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 7666187;
        $this->author = 'Михаил';
    }
...
class CParPassatSPB extends CParPassat{
    function __construct(){
        parent::__construct();
        $this->price_id = 7664327;
        $this->document_name= 'PassatSPB'.'_'.date('d-m-Y', time()).'_'.time().'.csv';
    }
}