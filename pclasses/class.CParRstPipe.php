...
class CParRstPipe extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.rstpipe.ru/assets/images/price/price_teh_truby.xls';
        $this->document_urls['price_truby_pnd_teh'] = 'http://www.rstpipe.ru/assets/images/price/price_truby_pnd_teh.xls';
        ///$this->document_urls['price_truby_pnd80_gaz'] = 'http://www.rstpipe.ru/assets/images/price/price_truby_pnd80_gaz.xls';
        //$this->coef = 1000;
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                $this->filter =  array(
                    ...
                    'cost2' => 4,
                    'coef' => 1,
                    'begin' => 'Трубы ПНД (ПЭ80)  ТУ 2248-001-09801575-2010',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->sheet = $this->objPHPExcel->getSheet(0)->toArray();
                $this->documentParsing();
            }else if($key == 'price_truby_pnd_teh'){
                $this->filter =  array(
                ...
                $this->sheet = $this->objPHPExcel->getSheet(0)->toArray();
                $this->documentParsing();
            }else if($key == 'price_truby_pnd80_gaz'){
