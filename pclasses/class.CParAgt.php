...
class CParAgt extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_url = 'http://ag-truba.ru/files/ag-truba.ru_%D0%92%D0%B5%D1%81%D1%8C_%D0%BF%D1%80%D0%B0%D0%B9%D1%81.xlsx';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 8390638;
    }
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    if(in_array($num_row, array($this->filter['horizontal']['to']['numeric']))){
                        $cost = (int) str_replace(' ','',preg_replace('/руб\./iu', '',$row));
