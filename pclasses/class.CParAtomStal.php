...
class CParAtomSteel1 extends CParMain{
    var $city_id;
    static $name_parser = array(
        'atomsteel' => 'АтомСталь Москва'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.atom-stal.su/price/listovojprokat.xls';
        $this->document_urls['pass1'] = 'http://www.atom-stal.su/price/truby.xls';
        $this->document_urls['pass2'] = 'http://www.atom-stal.su/price/metuzy.xls';
        $this->document_urls['pass3'] = 'http://www.atom-stal.su/price/nerzhaveika.xls';
        $this->document_urls['pass4'] = 'http://www.atom-stal.su/price/sortovojprokat.xls';
        //$this->document_urls['pass'] = 'http://www.atom-stal.su/price/atom-stal-su-price-truby.xls';
        ...
        $this->decimal = true;
        //$this->price_type = 'safe';
        $this->price_id = 12472344;
        $this->author = 'Феликс';
    }
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => "ТРУБЫ ЭЛЕКТРОСВАРНЫЕ (б/у) ",
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => "СТАЛЬ СОРТ Х/Т КАЛИБРОВКА КРУГ ",
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => "СТАЛЬ ФАСОН ПРОФИЛИ КВАДРАТ ",
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => "ТРУБЫ НЕРЖАВ. ЭЛ/СВАРНЫЕ ",
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => "ТРУБЫ НЕРЖАВ. БЕСШОВНЫЕ (продолжение)",
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => preg_replace('/Ǿ/iu','', preg_replace('/\(продолжение\)/iu','',preg_replace('/\?/iu','', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ',trim($header.' '.$treeString.' '.$name.' '.$this->filter['end'])))))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
