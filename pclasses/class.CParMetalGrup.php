...
class CParMetalGrup extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metalGrup' => 'МеталлГрупп'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://178.63.70.28/pricelists/moskva/MetalGrupp-Dipos/MetalGrupp-Dipos.xlsx';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 8400216;
        $this->author = 'Михаил';
    }
...
//                $this->documentParsing();
                ...
                $this->head_non = true;
                $this->documentLoad($path);
                $this->sheet = $this->objPHPExcel->getSheet($pages - 2)->toArray();
                $this->documentParsing();
                ...
                $this->head_non = true;
                $this->documentLoad($path);
                $this->sheet = $this->objPHPExcel->getSheet($pages - 3)->toArray();
                $this->documentParsing();
