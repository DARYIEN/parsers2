...
class CParSipost extends CParMain{
    var $city_id;
    static $name_parser = array(
        'sipost' => 'Сибирский поставщик'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://sipost.ru/index.php?id=3');
        $link = $parse->find('div#price-links a', 0);
        return 'http://sipost.ru/'.$link->href;
    }
}