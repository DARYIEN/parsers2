...
class CParMIG extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mig' => 'Металлургическая инвестиционная группа (МИГ)'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.migltd.ru/userfiles/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 10726103;
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(in_array($row, array('т', 'шт', 'руб.'))){
                        continue;
                    }
