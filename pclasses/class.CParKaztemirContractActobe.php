...
class CParKazTemirKontraktAktobe extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kaztemirkontrakt_aktobe' => 'Казтемирконтракт Актобе'
    );
    public $items = array();
