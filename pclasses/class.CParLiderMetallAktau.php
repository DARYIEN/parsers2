...
class CParLiderMetallAktau extends CParMain{
    var $city_id;
    static $name_parser = array(
        'lidermetallaktau' => 'Лидер-Металл'
    );
    public $items = array();
    function start(){
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($num_row == $this->filter['horizontal']['from']['numeric'] && count($rows) <= 1){
