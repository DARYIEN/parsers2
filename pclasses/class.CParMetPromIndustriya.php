...
class CParMetPromIndustriya extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metpromindustriya' => 'МетПромИндустрия'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls['main'] = 'http://ya1t.ru/upload/price.xls';
        $this->document_urls['main'] = 'http://178.63.70.28/pricelists/moskva/MetPromIndustrija/MetPromIndustrija.xlsx';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 13389267;
        $this->author = 'Михаил';
    }
