...
class CParRabotiagiStroy extends CParMain{
    var $city_id;
    static $name_parser = array(
        'RabotiagiStroy' => 'RabotiagiStroy'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://rabotiagi-stroy.ru/');
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => str_replace("Ž","Z",preg_replace('/Ǿ/iu','',preg_replace('/\?/iu','', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ',trim($this->filter['begin'].' '.$header.' '.$treeString.' '.$name.' '.$this->filter['end'])))))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
