...
class CParStroySet extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xls\W~', file_get_html('http://www.stroiset.ru/pricelist.html')->find('body',0)->innertext, $out);
        $links['main']='http://www.stroiset.ru'.$out[0][0];
         //p($out);
        //die();
