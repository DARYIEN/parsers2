...
class CParDantaDv extends CParMain{
    var $city_id;
    static $name_parser = array(
        'dantadv' => 'Данта-дальний Восток'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.danta-dv.ru/prays/prays_aprel_0.xls';
