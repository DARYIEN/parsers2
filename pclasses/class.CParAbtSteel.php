 ...
 * Time: 12:44
 */
class CParAbtSteel extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
       ...
       // $this->home_url = 'http://www.constali.ru/armatura-gladkaya-a1';
        ...
        $this->document_urls = array('http://www.abt-steel.ru/price-metall.html');
        $this->home_url = current($this->document_urls);
        $this->price_id = 8567622;
        $this->iconv = true;
    }
    ...
    function documentParsing($path){
        ...
        $div = $parse->find('div.str1, div.str2');
        if(!empty($div)){
            $result = array();
            foreach($div as $tr){
                $step = 1;
