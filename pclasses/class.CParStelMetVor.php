...
class CParStelMetVor extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.metallvrn.ru/download-price-22.html';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 8675824;
        $this->author = 'Феликс';
    }
    ...
    function processParsing(){
        foreach($this->document_list as $path){
            $this->filter =  array(
                'propusk' => array($this->n('C'),$this->n('D')),
                'cost1' => 2,
                'cost2' => 1,
                'cost3' => 0,
                'coef' => 1,
