...
class CParTdNovosib extends CParMain{
    var $city_id;
    static $name_parser = array(
        'tdnovosib' => 'Торговый дом Новосиб'
    );
    public $items = array();
    function start(){
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => 'Труба Б/У необработанная ',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => 'Труба Б/У востановленная ',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
