...
class CParMetallTskVoshod extends CParMain{
    var $city_id;
    static $name_parser = array(
        'tskvoshod' => 'ТСК Восход'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://tsk-voshod.ru/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11096909;
        $this->author = 'Феликс';
    }
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    if(in_array(trim($row), array('цена','цена м2'))){
