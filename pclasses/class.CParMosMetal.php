...
class CParMosMetal extends CParMain{
    var $city_id;
    public  $pages;
    public  $column;
    ...
    function __construct(){
        ...
        $this->document_urls['arm'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-armatura.xls';
        $this->document_urls['balki'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-balki.xls';
        $this->document_urls['kvadrat'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-kvadrat.xls';
        $this->document_urls['krug'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-krug.xls';
        $this->document_urls['list'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-listovoy-prokat.xls';
        $this->document_urls['truba'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-truby.xls';
        $this->document_urls['ugol'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-ugolki.xls';
        $this->document_urls['shveller'] = 'http://www.mmbaza.ru/prices/mmbaza.ru-shvellery.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 14441552;
        //$this->pages='truba';
        //$this->column = 'B';
        $this->author = 'Михаил';
    }
