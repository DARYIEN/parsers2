...
class CParOmskyElectronnyZavod extends CParMain{
    var $city_id;
    static $name_parser = array(
        'omskyelectronnyzavod' => 'ОМСКИЙ ЭЛЕКТРОДНЫЙ ЗАВОД (ОЭЗ)'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://electrod.info/')->find('body',0)->innertext, $out);
        $links['main']='http://electrod.info/'.$out[0][0];
       // p($out);
