...
class CParKastor extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        //$this->document_urls = $this->getUrl('http://kastor.umi.ru/prajs-list/');
        $this->document_urls['main'] = 'http://kastor.umi.ru/filemanager/download/453';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 14446083;
        $this->author = 'Михаил';
    }
