...
class CParPasTermo extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.plasttermo.ru/docs/file/pvc_fip/PVC_PRICE_2014.xls';
        $this->document_urls['hpvh'] = 'http://www.plasttermo.ru/docs/file/cpvc/cpvc_fip_price_rus_2014.xls';
        $this->document_urls['pph'] = 'http://www.plasttermo.ru/docs/file/pph100/price_pp_h100_FIP_2014.xls';
        $this->document_urls['pvdf'] = 'http://www.plasttermo.ru/docs/file/pvdf/Price_PVDF_FIP_2013.xls';
        $this->document_urls['ecoplastic'] = 'http://www.plasttermo.ru/docs/file/ekoplastik%20/ekoplastik_price_2012.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 999999999;
        $this->author = 'Михаил';
    }
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($this->filter['cost1']!==false && in_array($num_row, array($this->filter['horizontal']['to']['numeric'] - $this->filter['cost1']))){
                        if(strripos($row,'Евро')!== false)$this->filter['end']='Евро';
                        if(strripos($row,'руб.')!== false)$this->filter['end']='';
