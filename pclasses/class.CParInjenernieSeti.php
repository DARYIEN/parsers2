...
class CParInjenernieSeti extends CParMain{
    var $city_id;
    static $name_parser = array(
        'InjenernieSeti' => 'Инженерные Сети'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls = $this->getUrl('http://178.63.70.28/pricelists/SaintPetersburg/InzhenernyeSeti/priceTDIS.xlsx');
        $this->document_urls['main'] = 'http://178.63.70.28/pricelists/SaintPetersburg/InzhenernyeSeti/InzhenernyeSeti-Dipos.xlsx';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 13640518;
        $this->author = 'Михаил';
    }
...
class CParInjenernieSetiSPB extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13640519;
    }
}
class CParInjenernieSetiVladimir extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644086;
    }
}
class CParInjenernieSetiSaratov extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644114;
    }
}
class CParInjenernieSetiTver extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644089;
    }
}
class CParInjenernieSetiSamara extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644097;
    }
}
class CParInjenernieSetiNN extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644095;
    }
}
class CParInjenernieSetiTula extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644107;
    }
}
class CParInjenernieSetiKaluga extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644102;
    }
}
class CParInjenernieSetiTambov extends CParInjenernieSeti{
    function __construct(){
        parent::__construct();
        $this->price_id = 13644111;
    }
}