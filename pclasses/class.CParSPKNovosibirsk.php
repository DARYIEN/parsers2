...
class CParSPKNovosibirsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spknovosibirsk' => 'СПК-Новосибирск'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['nerj'] = 'http://www.spk.ru/price/spk-novosib/_m_/38805/_p_/file';
        $this->document_urls['prof'] = 'http://www.spk.ru/price/spk-novosib/_m_/12076/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267648;
        $this->author = 'Михаил';
    }
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'nerj'){
                ...
                $this->filter =  array(
                    ...
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => $this->num('ABC'),
                    'baseOfFixCell' => $this->num('D'),   //указывать одну букву
                    'defaultfixcell' => false,
                    //'columns' => array('D','B','V','AZ'),
                    'horizontal' => array(
                        'to' => column('E'),
                ...
                $this->filter =  array(
                    ...
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => $this->num('BCD'),
                    'baseOfFixCell' => $this->num('E'),   //указывать одну букву
                    'defaultfixcell' => false,
                    //'columns' => array('D','B','V','AZ'),
                    'horizontal' => array(
                        'to' => column('F'),
                ...
                $this->filter =  array(
                    ...
                    'tree' => false,
                    'fixcell' => false,
                    'baseOfFixCell' => false,   //указывать одну букву
                    'defaultfixcell' => false,
                    //'columns' => array('D','B','V','AZ'),
                    'horizontal' => array(
                        'to' => column('F'),
                ...
                $this->filter =  array(
                    ...
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => $this->num('BCDE'),
                    'baseOfFixCell' => $this->num('F'),   //указывать одну букву
                    'defaultfixcell' => false,
                    //'columns' => array('D','B','V','AZ'),
                    'horizontal' => array(
                        'to' => column('G'),
