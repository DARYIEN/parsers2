...
class CParEkipMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ekipmetall' => 'Экип-Металл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://ekip-metall.ru/d/11867/d/price.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 7490157;
        $this->author = 'Михаил';
    }
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://ekip-metall.ru/page762207')->find('body',0)->innertext, $out);
        $links['main']='http://ekip-metall.ru/page762207'.$out[0][0];
        // p($out);
