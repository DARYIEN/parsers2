...
class CParDemidov extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->decimal = true;
        $this->document_urls = $this->getUrls();
    ...
    function processParsing(){
        ...
        foreach($this->document_list as $path){
            $this->filter = array('cost' => array(1), 'hide' => array(0,3,4), 'coef' => 1, 'selector' => 'div.b-results__table table');
...
//                  die();
    ...
    public function getUrls(){
        $href = array();
        for($i = 1; $i<=203; $i++){
            $href[] = 'http://www.demidovsteel.ru/price_list/?PAGEN_1='.$i;
            //break;
        }
