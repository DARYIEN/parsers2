...
class CParEnergomonolit extends CParMain{
    var $city_id;
    static $name_parser = array(
        'energomonolit' => 'energomonolit'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://energomonolit.ru/d/953336/d/prayslist.xlsx';
        //$this->document_urls['beton'] = 'http://www.avtobeton.ru/images/price-avtobeton.xls';
