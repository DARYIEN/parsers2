...
class CParAAALiderMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'aaalidermetall' => 'ААА Лидер-Металл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://178.63.70.28/pricelists/Krasnoyarsk/AAA-Lider-metall.com/ААА%20Лидер-Металл-Прайс.xlsx';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11308880;
        $this->author = 'Михаил';
    }
