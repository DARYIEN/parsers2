...
class CParUgKomplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ugkomplect' => 'Юг-комплект'
    );
    public $items = array();
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://юг-комплектметалл.рф/templates/beez/price/price2.xls';
        $this->document_urls['passive'] = 'http://юг-комплектметалл.рф/templates/beez/price/price3.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11430305;
        $this->author = 'Феликс';
    }
