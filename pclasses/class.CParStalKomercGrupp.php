...
class CParStalKomercGrupp extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalkomercgrupp' => 'Сталь коммерц групп'
    );
    public $items = array();
    function start(){
    ...
    function documentParsing(){
        ...
        $treeString = '';
        $new_header=false;
        $header ='Арматура  А3 / ГОСТ 5781-82 ст.35ГС';
