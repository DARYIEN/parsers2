...
class CParComplectStroy extends CParMain{
    var $city_id;
    static $name_parser = array(
        'complectstroy' => 'Контакт'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls['main'] = 'http://trubaomsk.ru/uploads/ext_text/files/price/price_metalloprokat_2014.xlsx';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11782509;
        $this->author = 'Михаил';
    }
    ...
    function processParsing(){
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    'propusk' => $this->num('FGHJ'),
                    'cost1' => 2,
                    'cost2' => 0,
                    'coef' => 1,
                    'end' => '',
                    'header' => 'Сетка кладочная',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'end' => 'Скоба строительная (кованная)',
                    'header' => true,
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://setka96.ru/price')->find('body',0)->innertext, $out);
        $links['main']='http://setka96.ru'.$out[0][0];
       // p($out);
