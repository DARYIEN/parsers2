...
class CParPinInstrument extends CParMain{
    var $city_id;
    static $name_parser = array(
        'pininstrument' => 'Пин-инструмент'
    );
    public $items = array();
    function start(){
