...
class CParMetallHoldingVladimir extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metholding' => 'Металл-Холдинг'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.metall-holding.ru/files/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 9962446;
        $this->author = 'Феликс';
    }
