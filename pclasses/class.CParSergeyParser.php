...
class CParSergeyParser extends CParMain{
    var $city_id;
    static $name_parser = array(
        'sergeyparser' => 'SergeyParser'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://185.248.102.77/pricelists/' . CParMain::$sergeyParserServer . '/' . CParMain::$sergeyParserPath;
