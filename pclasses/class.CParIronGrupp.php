...
class CParIronGrupp extends CParMain{
    var $city_id;
    static $name_parser = array(
        'irongrupp' => 'Айрон Групп'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://irongroup.ru/ru/prayslisty/')->find('body',0)->innertext, $out);
        $links['main']=$out[0][0];
        //p($out);
