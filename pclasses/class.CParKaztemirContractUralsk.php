...
class CParKazTemirKontraktUralsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kaztemirkontrakt_uralsk' => 'Казтемирконтракт Уральск'
    );
    public $items = array();
