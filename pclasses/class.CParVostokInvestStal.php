...
class CParVostokInvestStal extends CParMain{
    var $city_id;
    static $name_parser = array(
        'vostokinveststal' => 'Восток-ИнвестСталь'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://vi-stal.ru/price/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10510628;
    }
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($num_row == 4||$num_row == 2||$num_row == 5||$num_row == 6||$num_row == 7||$num_row == 8|| $num_row == 9){
                        continue;
                    }
