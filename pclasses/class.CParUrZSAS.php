...
class CParUrZSAS extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.zavodsetka.ru/files/price/Prays%2032%2035%20UrZSAS.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11782507;
        $this->author = 'Михаил';
    }
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}?\W~', file_get_html('http://www.zavodsetka.ru/skachat_prays_list')->find('body',0)->innertext, $out);
        $links['main']=$out[0][0];
        //p($out);
...
class CParUrZSASChelyab extends CParUrZSAS{
    function __construct(){
        parent::__construct();
        $this->price_id = 12355817;
    }
}