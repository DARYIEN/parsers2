...
class CParInfrastel extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://infrastel-met.tiu.ru/price_lists.html');
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 1,
                    'coef' => 1,
                    'begin' => 'Арматура А3 розница (до 5т)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 1,
                    'coef' => 1,
                    'begin' => 'Арматура А1 розница (до 5т)',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
    ...
    public function getUrl($url){
        foreach(file_get_html($url)->find('body a') as $link){
            ...
            if(strripos($href,'.xls' )!==false){
               // if(strripos($href, parse_url($url, PHP_URL_HOST)) !== 0){
