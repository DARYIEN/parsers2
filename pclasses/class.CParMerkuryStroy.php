...
class CParMerkuryStroy extends CParMain{
    var $city_id;
    static $name_parser = array(
        'merkurystroy' => 'МеркурийСтрой'
    );
    public $items = array();
    function start(){
