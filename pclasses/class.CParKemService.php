...
class CParKemService extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kemservice' => 'Кемерово сервис'
    );
    public $items = array();
