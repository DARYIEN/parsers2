...
class CParMetalInvestSeveroZapad extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metalinvestseverozapad' => 'Металлинвест Северо-Запад'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.metal-in.ru/static/price-truby.xls';
        $this->document_urls['sort'] = 'http://www.metal-in.ru/static/price-sortovoy_prokat.xls';
        $this->document_urls['nerj'] = 'http://www.metal-in.ru/static/price-kotel.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11520463;
        $this->author = 'Михаил';
    }
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => 'ТРУБЫ ПРОФИЛЬНЫЕ Ст 3 СП/ПС5 ; 09Г2С - 12',
                    'skleyka' => true,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
