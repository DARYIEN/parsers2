...
class CParStroyzacaz extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->dual_cost = true;
        $this->author = 'Михаил';
        $this->document_urls = array(   'http://stroyzacaz.ru/pricelist/',
                                    );
    ...
    function documentParsing($path){
        ...
        $tables = $parse->find('div.cpt_maincontent table');
//        if(!empty($headers)){
