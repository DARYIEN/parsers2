...
class CParMosVodProm extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mosvodprom' => 'Мосводопром'
    );
    public $items = array();
    function start(){
