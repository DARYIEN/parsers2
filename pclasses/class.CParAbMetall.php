 ...
 * Time: 12:44
 */
class CParAbMetall extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    var $company_name;
    public $temp = array();
    public $stringForFind = 'td.mFrame div div table tbody tr';
    ...
    function __construct(){
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_url = 'http://ab-metal.ru/index/price/0-2';
        $this->price_id = 8530972;
        $this->iconv = true;
    }
