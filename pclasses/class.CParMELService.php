...
class CParMELService extends CParMain{
    var $city_id;
    static $name_parser = array(
        'melservice' => 'МЭЛ-сервис'
    );
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.armatura-str.ru/');
        $links = 'http://www.armatura-str.ru'.$parse->find('div.downl_price a', 0)->href;
        return $links;
    }
}