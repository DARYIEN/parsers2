...
class CParSibTorg extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        $parse = file_get_html('http://metallsibir.ru/');
        $link = $parse->find('div.dowprice a.dow-xls', 0);
        return 'http://metallsibir.ru/'.$link->href;
    }
}