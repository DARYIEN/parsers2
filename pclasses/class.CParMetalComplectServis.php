...
class CParMetalComplectServis extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metalcomplectservis' => 'МеталлКомплектСервис (МКС)'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://mksnn.ru/price/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267471;
        $this->author = 'Михаил';
    }
