...
class CParMetaltorgMetalBaza extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->decimal = true;
        $this->document_urls = array(   'http://metalo-baza.ru/price/',
                                    );
    ...
    function processParsing(){
        ...
        foreach($this->document_list as $path){
            $this->filter = array('cost' => array(1), 'hide' => array(), 'coef' => 1, 'selector' => 'content table');
