...
class CParLegirovanieStali extends CParMain{
    var $city_id;
    static $name_parser = array(
        'legstali' => 'Легированные стали'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://xn----7sbbfeldvfviuak3axr2n.xn--p1ai/prajs-list/');
        $link = $parse->find('span span span span span a', 0);
        return $link->href;
    }
}