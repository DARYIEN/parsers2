...
class CParSPKKrasnodar extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spkkrasnodar' => 'СПК-Краснодар'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.spk.ru/price/spk-krasnodar/_m_/9505/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267650;
        $this->author = 'Михаил';
    }
