 ...
 * Time: 12:44
 */
class CParMetallotyorgChelyab extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        //$this->home_url = 'http://www.mt174.ru/?id=6687';
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_url = 'http://www.mt174.ru/?id=6687';
        $this->price_id = 8793058;
        $this->iconv = true;
    }
        ...
        if(!empty($table)){
            foreach($table as $tr){
                ...
                foreach($tr->find('td') as $td){
                    ...
                    $temp[] =  trim(preg_replace('/'.chr(160).'/', '', $td->plaintext));
                }
                $this->temp[] = $temp;
            }
        }
