...
class CParPromSnabMetallService extends CParMain{
    var $city_id;
    static $name_parser = array(
        'promsnabmetallservice' => 'ПромСнабМеталл-Сервис'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://psm-steel.ru/assets/files/price-nerzhav.xlsx';
        $this->document_urls['setka'] = 'http://psm-steel.ru/assets/files/setka.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11782515;
        $this->author = 'Михаил';
    }
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => 'Нержавеющие (12Х18Н10Т) по ГОСТ 3826-82, " микро" ТУ 14-4-507-99 (74), ТУ   ',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => ' Латунные (Л-80) по ГОСТ 6613-86',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
