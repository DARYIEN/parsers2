...
class CParKazTemirKontraktAtirau extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kaztemirkontrakt_atyrau' => 'Казтемирконтракт Атырау'
    );
    public $items = array();
