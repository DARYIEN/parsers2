...
class CParStaliningrad extends CParMain{
    var $city_id;
    static $name_parser = array(
        'staliningrad' => 'Сталиинград'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://staliningrad.ru/ceny');
        $link = $parse->find('div.container div.content2 p a', 0);
        return 'http://staliningrad.ru'.$link->href;
    }
}