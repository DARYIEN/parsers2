...
class CParPervayaStroytelnayaBaza extends CParMain{
    var $city_id;
    static $name_parser = array(
        'pervayaStroytelnayaBaza' => 'Первая Строительная База'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://psbaza.ru/metalloprokat1');
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if(in_array(trim($row), array('Лист алюминевый'))){
                        $this->filter['begin'] = 'Лист алюминевый';
                    }
