...
class CParLenStalinvest extends CParMain{
    var $city_id;
    static $name_parser = array(
        'lenstalinvest' => 'ЛенСтальИнвест'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://lenst.su/data/truba.xls';
        $this->document_urls['sort'] = 'http://lenst.su/data/sort.xls';
        $this->document_urls['nerj'] = 'http://lenst.su/data/nerzh.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11742059;
        $this->author = 'Михаил';
    }
