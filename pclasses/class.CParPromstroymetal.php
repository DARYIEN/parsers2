...
class CParPromstroymetal extends CParMain{
    var $city_id;
    static $name_parser = array(
        'promstroymetal' => 'МК ПРОМСТРОЙМЕТАЛ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['trubakrug'] = 'http://www.mkpsm.ru/prices/price1.xls';
        $this->document_urls['profil'] = 'http://www.mkpsm.ru/prices/price4.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 8166686;
        $this->author = 'Михаил';
    }
