...
class CParSunPipeSesvice extends CParMain{
    var $city_id;
    static $name_parser = array(
        'sunpipesesvice' => 'Сан Пайп Сервис'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://sanpipes.ru/files/pages/%D0%9F%D0%A0%D0%90%D0%99%D0%A1%2019062014.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12284472;
        $this->author = 'Михаил';
    }
    ...
    public function getUrl(){
        //preg_match_all('~href=\W.*?xlsx{0,1}\W~', file_get_html('http://sanpipes.ru/')->find('body',0)->innertext, $out);
        $parse = file_get_html('http://sanpipes.ru/');
        $link =
        $links['main']='http://sanpipes.ru'.$parse->find('div.btnPrice a', 0)->href;
       // p($out);
