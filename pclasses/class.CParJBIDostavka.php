...
class CParJBIDostavka extends CParMain{
    var $city_id;
    static $name_parser = array(
        'gbidostavka' => 'ЖБИ Доставка'
    );
    public $items = array();
    function start(){
