...
class CParSpbSpk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spk' => 'Сталепромышленная компания (СПК)'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.spb.spk.ru/price/spk-spb/_m_/18255/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11041397;
        $this->author = 'Феликс';
    }
