...
class CParSaverhot extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://saverhot.ru/price')->find('body',0)->innertext, $out);
        $links['main']='http://saverhot.ru'.$out[0][0];
       // p($out);
...
class CParSaverhotEkb extends CParSaverhot{
    function __construct(){
        parent::__construct();
        $this->price_id = 12220311;
    }
}