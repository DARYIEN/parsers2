...
class CParSevernyBereg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'severnybereg' => 'Северный Берег'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://sb-metalloprokat.ru/Severnyi-Bereg-price.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 13833722;
        $this->author = 'Михаил';
    }
