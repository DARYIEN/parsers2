 ...
 * Time: 12:44
 */
class CParAdamantSteel extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
       ...
       // $this->home_url = 'http://www.constali.ru/armatura-gladkaya-a1';
        ...
        $this->document_urls = array('http://adamantsteel.ru/price/');
        $this->home_url = current($this->document_urls);
        $this->price_id = 8482675;
        $this->iconv = true;
    }
        ...
        if(!empty($tables)){
            ...
            foreach($tables as $table){
                ...
                foreach($table->find('tr') as $tr){
                    $name = '';
                    $cost = '';
                    if ($step==2) $max_td = count($tr->find('td'));
