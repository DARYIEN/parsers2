...
class CParOmerta extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metallosort.ru/z1/1.xls';
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'tree' => false,
                    'fixcell' => $this->num('B'),
                    'baseOfFixCell' => $this->num('V'),
                    'defaultfixcell' => '',
                    'columns' => array('B','V','AZ'),
                    'horizontal' => array(
                        'to' => array('numeric' => 51),
                        'from' => array('numeric' => 1)),
                    'vertical' => array(
