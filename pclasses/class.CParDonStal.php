...
class CParDonStal extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_urls = array(   'http://www.don-stal.ru/price/',
                                    );
        $this->home_url = current($this->document_urls);
        $this->price_id = 8651324;
        $this->iconv = true;
    }
    ...
    function documentParsing($path){
        ...
        if(!empty($headers)){
            ...
            //p($text);
               ...
               $cell=array(
                   'standart'=>array('stop_cell'=>3, 'cost_cell1'=>4, 'cost_cell2'=>5,),
               );
