...
class CParTechKrep extends CParMain{
    var $city_id;
    static $name_parser = array(
        'techkrep' => 'Tech-KREP (Теч-Крип)'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.balt-krep.ru/files/t-krep_price.xls';
