...
class CParVolgogradSpecMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'volgogradspecmetall' => 'ВолгоградСпецМеталл'
    );
    public $items = array();
    function start(){
