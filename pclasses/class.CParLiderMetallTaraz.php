...
class CParLiderMetallTaraz extends CParMain{
    var $city_id;
    static $name_parser = array(
        'lidermetalltaraz' => 'Лидер-Металл'
    );
    public $items = array();
    function start(){
