...
class CParMetallocentrTaganrog extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metallocentrtaganrog' => 'Металлоцентр'
    );
    public $items = array();
    function start(){
