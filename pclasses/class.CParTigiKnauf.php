...
class CParTigiKnauf extends CParMain{
    var $city_id;
    static $name_parser = array(
        'tigiknauf' => 'ТИГИ-КНАУФ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://www.tigi-knauf.ru/userfiles/image/Price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 77777777;
    }
