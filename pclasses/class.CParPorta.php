...
class CParPorta extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        //preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://porta-chel.ru/')->find('body',0)->innertext, $out);
        $parse = file_get_html('http://porta-chel.ru/');
        $link = $parse->find('div#sidebar div.price-block a', 1);
        $links['main']='http://porta-chel.ru'.$link->href;
