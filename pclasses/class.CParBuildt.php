...
class CParBuildt extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->dual_cost = true;
        $this->author = 'Михаил';
        $this->document_urls = array(   'http://buildt.ru/index.php?ukey=pricelist',
                                    );
    ...
    function documentParsing($path){
        ...
        $tables = $parse->find('center table');
//        if(!empty($headers)){
