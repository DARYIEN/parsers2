...
class CParPromtehcomplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'promtehcomplect' => 'Промтехкомплект'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://trubaomsk.ru/metal-price')->find('body',0)->innertext, $out);
        $links['main']='http://trubaomsk.ru/metal-price'.$out[0][0];
       // p($out);
