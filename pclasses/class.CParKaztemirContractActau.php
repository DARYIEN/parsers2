...
class CParKazTemirKontraktAktau extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kaztemirkontrakt_aktau' => 'Казтемирконтракт Актау'
    );
    public $items = array();
