...
class CParNLMK extends CParMain{
    var $city_id;
    static $name_parser = array(
        'nlmk' => 'Новолипецкая металлобаза'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['izdel'] = 'http://nlmk-baza.com/upload/price/fevral2014_prays-list_na_izdeliya_.xls';
        $this->document_urls['metall'] = 'http://nlmk-baza.com/upload/price/07.03.2014__prays_nalichie_na_sklade.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 8471091;
    }
