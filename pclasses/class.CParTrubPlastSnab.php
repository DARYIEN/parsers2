...
class CParTrubPlastSnab extends CParMain{
    var $city_id;
    static $name_parser = array(
        'trubplastsnab' => 'ТРУБПЛАСТСНАБ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://www.trubplastsnab.ru/files/TRUBPLASTSNAB_PRICE.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11487366;
    }
