...
class CParMetallosfera extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mtallosfera' => 'Металлосфера'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.metallosfera.ru/files/general_prise.xls';
        $this->document_urls['truba'] = 'http://www.metallosfera.ru/files/trub_prokat.xls';
        $this->document_urls['list'] = 'http://www.metallosfera.ru/files/list_prokat.xls';
        $this->document_urls['sort'] = 'http://www.metallosfera.ru/files/sort_prokat.xls';
