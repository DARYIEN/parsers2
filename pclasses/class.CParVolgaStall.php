...
class CParVolgaStall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'volgastall' => 'Волга-Сталь'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://volgasteel.ru/netcat_files/135/87/Prays_list_431.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267615;
        $this->author = 'Михаил';
        $this->header='';
    }
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://volgasteel.ru/')->find('body',0)->innertext, $out);
        $links['main']=$out[0][0];
        //p($out);
...
class CParVolgaStallTaljatti extends CParVolgaStall{
    function __construct(){
        parent::__construct();
        $this->price_id = 12267607;
    }
}