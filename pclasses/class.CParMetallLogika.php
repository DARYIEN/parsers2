...
class CParMetallLogika extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metlogika' => 'Металл Логика'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.omsk.spk.ru/');
        $link = $parse->find('td tr h3 a.link1', 0);
        return 'http://www.omsk.spk.ru'.$link->href;
    }
}