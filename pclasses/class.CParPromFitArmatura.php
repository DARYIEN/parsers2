...
class CParPromFitArmatura extends CParMain{
    var $city_id;
    static $name_parser = array(
        'promfitarmatura' => 'ПромФитАрматура'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.promfit.ru/prise.xls';
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'baseOfFixCell' => false,
                    'defaultfixcell' => '',
                    'columns' => array('Y','AL','AN'),
                    'horizontal' => array(
                        'to' => array('numeric' => 39),
                        'from' => array('numeric' => 24)),
                    'vertical' => array(
                        'to' => array(
                            'numeric' => 36),
                        'from' => array(
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => 'Ру1,6',
                    'header' => 'Фланец плоский нержавеющий',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
