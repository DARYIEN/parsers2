...
class CParStalServis extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalservis' => 'Сталь Сервис'
    );
    public $items = array();
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'coef' => 1,
                    'end' => '',
                    'header' => 'Труба квадратного сечения ',
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => false,
