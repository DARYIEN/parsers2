...
class CParMetallGroupSZ extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metallgroupsz' => 'МеталлГрупп Северо запад'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://mgsz.ru/price.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 11041395;
        $this->author = 'Феликс';
    }
    ...
    function processParsing(){
        foreach($this->document_list as $path){
            ...
            $this->documentParsing();
            $this->filter =  array(
                'propusk' => array($this->n('E'),$this->n('F'),$this->n('G')),
                'cost1' => false,
                'cost2' => false,
                'cost3' => 0,
                'coef' => 1,
