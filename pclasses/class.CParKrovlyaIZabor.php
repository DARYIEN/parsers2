...
class CParKrovlyaIZabor extends CParMain{
    var $city_id;
    static $name_parser = array(
        'krovlyaizabor' => 'КРОВЛЯ и ЗАБОР'
    );
    public $items = array();
    function start(){
