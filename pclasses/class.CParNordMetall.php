...
class CParNordMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'nordmetall' => 'Норд-Металл'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://nordmetallspb.ru/price')->find('body',0)->innertext, $out);
        $links['main']='http://nordmetallspb.ru'.$out[0][0];
        //p($out);
        //die();
