...
class CParProMetiz extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.fundamentnye-bolty.ru/prices/113303/download';
        $this->document_urls['spilka'] = 'http://www.fundamentnye-bolty.ru/prices/113304/download';
        $this->document_urls['gayka'] = 'http://www.fundamentnye-bolty.ru/prices/113305/download';
        $this->document_urls['fund'] = 'http://www.fundamentnye-bolty.ru/prices/137959/download';
    ...
    function documentParsing(){
        ...
        foreach($this->sheet as $rows){
            ...
            if(!empty($name)&& !empty($costs)){
                $this->items[] = array('name' => preg_replace('/Ǿ/iu','',preg_replace('/\?/iu','', preg_replace('/_/iu',' ', preg_replace('/;/iu','!', preg_replace('/\s+/iu',' ',trim($header.' '.$treeString.' '.$name.' '.$this->filter['end'])))))), 'cost' => $costs);
            }
            $name = '';
            $cost = '';
            unset($costs);
