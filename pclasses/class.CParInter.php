...
class CParInter extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metal-ppu.ru/images/price/ppu.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 13833680;
        $this->author = 'Михаил';
    }
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => '1 пог.м. трубы в ППУ-изоляции ПЭ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => '1 пог.м. трубы в ППУ-изоляции ОЦ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Услуги по изоляции 1 пог.м. трубы (труба Заказчика) ПЭ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Услуги по изоляции 1 пог.м. трубы (труба Заказчика) ОЦ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFG'),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Отвод 90 (L=500) ПЭ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFGH'),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Отвод 90 (L=500) ОЦ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFGHI'),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Неподвижная опора ПЭ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFGHIJ'),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Неподвижная опора ОЦ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Концевой элемент с кабелем вывода ПЭ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
                ...
                $this->filter =  array(
                    'propusk' => $this->num('DEFGHIJKL'),
                    'cost1' => false,
                    'cost2' => 0,
                    'coef' => 1,
                    'begin' => 'Концевой элемент с кабелем вывода ОЦ',
                    'end' => '',
                    'header' => false,
                    'skleyka' => false,
                    'dualheader'=>false,
