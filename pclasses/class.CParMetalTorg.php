...
class CParMetalTorg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metaltorg' => 'МеталлТорг-Metall247'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://metall247.ru/prays-list/')->find('body',0)->innertext, $out);
        $links['main']=array_pop($out[0]);
        //p($out);
        //p($links);
        //die();
