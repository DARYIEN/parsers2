...
class CParUralsibNeva extends CParMain{
    var $city_id;
    static $name_parser = array(
        'uralsibneva' => 'УРАЛСИБ-НЕВА'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://178.63.70.28/pricelists/moskva/UralsibNeva/УРАЛСИБ-НЕВА%20-%20Прайс.xlsx';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10962747;
    }
