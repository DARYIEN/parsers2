...
class CParDianStroy extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.dianstroy.ru/pages/files/kirpich.xls';
        $this->document_urls['kamensnenovoy'] = 'http://www.dianstroy.ru/pages/files/kamensnenovoy.xls';
        $this->document_urls['bloki'] = 'http://www.dianstroy.ru/pages/files/bloki.xls';
        $this->document_urls['koltsakolodzev'] = 'http://www.dianstroy.ru/pages/files/koltsakolodzev.xls';
        $this->document_urls['plitiperekritiya'] = 'http://www.dianstroy.ru/pages/files/plitiperekritiya.xls';
        $this->document_urls['asbestotsementnieizdeliya'] = 'http://www.dianstroy.ru/pages/files/asbestotsementnieizdeliya.xls';
        //$this->coef = 1000;
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'dualheader'=>false,
                    'tree' => false,
                    'fixcell' => $this->num('ACD'),
                    'baseOfFixCell' => $this->num('III'),
                    'defaultfixcell' => false,
                    //'columns' => array('D','B','V','AZ'),
                    'horizontal' => array(
                        'to' => column('J'),
                ...
                $this->sheet = $this->objPHPExcel->getSheet(0)->toArray();
                $this->documentParsing();
            }else if($key == 'asbestotsementnieizdeliya'){
                $this->filter =  array(
                    'propusk' => $this->num('C'),
                    'cost1' => false,
                    'cost2' => 0,
