...
class CParMetalloTorgKrasnoyarsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'MetalloTorg_krasn' => 'МеталлТорг Красноярск'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://bsm.zurbazar.ru/kompanii/prais-list/');
        $link = $parse->find('div.content div.center div.newprice table tbody a', 0);
        return 'http://bsm.zurbazar.ru/'.$link->href;
    }
}