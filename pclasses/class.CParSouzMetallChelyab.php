...
class CParSouzMetallChelyab extends CParMain{
    var $city_id;
    static $name_parser = array(
        'souzmetall' => 'Союз Металл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://souzmet74.ru/file/13.02.14%20Souz-Metall.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 8530256;
    }
