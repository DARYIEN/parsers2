...
class CParDomStroyKazan extends CParMain{
    var $city_id;
    static $name_parser = array(
        'domstroykazan' => 'ДОМСТРОЙ'
    );
    public $items = array();
    function start(){
