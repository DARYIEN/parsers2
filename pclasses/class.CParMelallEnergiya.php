...
class CParMelallEnergiya extends CParMain{
    var $city_id;
    static $name_parser = array(
        'melallenergiya' => 'Металл-Энергия'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = '178.63.70.28/pricelists/moskva/METALL-ENERGIYA/METALL-ENERGIYA-Price.xlsx';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 13562534;
        $this->author = 'Михаил';
    }
    ...
    function processParsing(){
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(16)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(18)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(20)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(21)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(22)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(23)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(24)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(25)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(26)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(27)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(28)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(29)->toArray();
                $this->documentParsing();
                ...
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(40)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(41)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(43)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(44)->toArray();
                $this->documentParsing();
                ...
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(19)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(30)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(35)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(39)->toArray();
                $this->documentParsing();
                $this->sheet = $this->objPHPExcel->getSheet(42)->toArray();
                $this->documentParsing();
                ...
                $this->head_non = true;
                $this->documentLoad($path);
                $this->sheet = $this->objPHPExcel->getSheet(17)->toArray();
                $this->documentParsing();
            }else if($key == 'prof'){
