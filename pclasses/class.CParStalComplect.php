...
class CParStalComplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalcomplect' => 'Сталь-Комплект'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://stal-komplekt.ru/index.php?page=skachat-prajs-list');
        //$this->document_urls['main'] = 'http://stal-komplekt.ru/uploads/Price/28.05.2014%20.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11743462;
        $this->author = 'Михаил';
    }
