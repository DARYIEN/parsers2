...
class CParMelallservisNN extends CParMain{
    var $city_id;
    static $name_parser = array(
        'melallservisnn' => 'МЕТАЛЛСЕРВИС-НН'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        //$this->document_urls['main'] = 'http://met-opttorg.ru/files/price_metopt.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267474;
        $this->author = 'Михаил';
    }
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://metall-nn.ru/catalog/trubi/')->find('body',0)->innertext, $out);
        $links['main']='http://metall-nn.ru'.$out[0][1];
        //p($out);
