...
class CParStalGroop extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalgroop' => 'СтальГрупп '
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.stalgroop.ru/prajs-list/');
        $link = $parse->find('a.b-price__link', 0);
        return 'http://www.stalgroop.ru'.$link->href;
    }
}