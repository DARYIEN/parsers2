...
class CParMetallocentrAstrahan extends CParMain{
    var $city_id;
    static $name_parser = array(
        'MetallocentrAstrahan' => 'Астраханский Металлоцентр'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://astrmetallocentr.ru/metall.xls';
