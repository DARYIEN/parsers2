...
class CParIronCommerceCompanyAlmata extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ironcommercecompanyalmata' => 'IRON COMMERCE COMPANY'
    );
    public $items = array();
    function start(){
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($row == 'Стоимость за тонну' && in_array($num_row, $this->num('F'))){
                        $this->filter['propusk']=$this->num('BDF');
                    }
                    if($row == 'Стоимость за тонна' && in_array($num_row, $this->num('F'))){
                        $this->filter['propusk']=$this->num('BDF');
                    }
                    if($row == 'Производство' && in_array($num_row, $this->num('F'))){
                        $this->filter['propusk']=$this->num('BD');
                    }
