...
class CParProfProkat extends CParMain{
    var $city_id;
    static $name_parser = array(
        'profprokat' => 'ПрофПрокат'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://www.profprokat.ru/price/price_profprokat.xls';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 10912378;
    }
