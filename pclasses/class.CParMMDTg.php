...
class CParMMDTg extends CParMain{
    var $city_id;
    static $name_parser = array(
        'MMDTg' => 'MMD Trade Group'
    );
    function start(){
    ...
    public function getUrl(){
        $parse = file_get_html('http://mdtg.ru/');
        $link = $parse->find('ul.list-price a', 0);
        return 'http://mdtg.ru'.$link->href;
    }
}