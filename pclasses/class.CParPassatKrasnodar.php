...
class CParPassatKrasnodar extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_name = current(array_keys(self::$name_parser)).'Krasnodar'.date('d-m-Y', time()).'_'.time().'.csv';
        $this->document_urls['main'] = 'http://www.allmetal.ru/upload/files/price_PASSAT_krasnodar.xls';
        //$this->document_urls['krepezh'] = 'http://www.zitar.ru/files/price/64/%CA%F0%E5%EF%E5%E6%ED%E0%FF%20%F2%E5%F5%ED%E8%EA%E0.XLS';
        //$this->coef = 1000;
        $this->dual_cost = true;
        $this->price_id = 7667055;
        $this->author = 'Михаил';
    }
...
class CParPassatEkb extends CParPassatKrasnodar{
    function __construct(){
        parent::__construct();
        $this->document_urls['main'] = 'http://www.allmetal.ru/upload/files/price_PASSAT_ekb.xls';
        $this->price_id = 7667922;
        $this->document_name= 'PassatEkb'.'_'.date('d-m-Y', time()).'_'.time().'.csv';
    }
}