...
class CParSantehArmatura extends CParMain{
    var $city_id;
    static $name_parser = array(
        'santeharmatura' => 'СантехАрматура'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://santexarm.ru/pricelist/zapornaya-armatura-pricelist.xls';
        $this->document_urls['met'] = 'http://santexarm.ru/pricelist/metalloprokat-pricelist.xls';
        $this->document_urls['stal'] = 'http://santexarm.ru/pricelist/stalnye-elementy-truboprovoda-pricelist.xls';
        //$this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12272485;
        $this->author = 'Михаил';
    }
