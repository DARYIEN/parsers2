...
class CParTransArm extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        //$this->document_urls = $this->getUrl('http://www.staltrub.ru/auxpage_price/');
        //$this->document_urls['main'] = 'http://transarm.com/upload/mce/file/__16.02.2015.xls';
	$this->document_urls['main'] = 'http://transarm.com/upload/mce/file/zapornaya-truboprovodnaya-armatura-prajs-list-2017-transarm.xls';
        //$this->coef = 1000;
