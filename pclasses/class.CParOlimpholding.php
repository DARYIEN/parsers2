...
class CParOlimpholding extends CParMain{
    var $city_id;
    static $name_parser = array(
        'CParOlimpholding' => 'Мир ЖБИ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls = $this->getUrl('http://olimpholding.tiu.ru/price_lists.html');
