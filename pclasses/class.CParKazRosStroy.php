...
class CParKazRosStroy extends CParMain{
    var $city_id;
    static $name_parser = array(
        'kazrosstroy' => 'Казросстрой'
    );
    public $items = array();
    function start(){
