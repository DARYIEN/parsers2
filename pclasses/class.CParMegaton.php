...
class CParMegaton extends CParMain{
    var $city_id;
    ...
    public function getUrl(){
        $parse = file_get_html('http://ooo-megatonn.ru/metalloprokat2');
        $link = $parse->find('div.content article ul li a', 0);
        return 'http://ooo-megatonn.ru'.$link->href;
    }
}