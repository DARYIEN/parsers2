...
class CParIronCommerceCompanyAktau extends CParMain{
    var $city_id;
    static $name_parser = array(
        'ironcommercecompanyaktau' => 'IRON COMMERCE Актау'
    );
    public $items = array();
    function start(){
