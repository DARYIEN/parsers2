...
class CParAlmaST extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->document_urls = array('http://www.dvbib.ru/prajs/');
        $this->home_url = current($this->document_urls);
        $this->price_id = 10510610;
        $this->iconv = true;
    }
                ...
                foreach($table->find('tr') as $tr){
                    ...
                    foreach($tr->find('td') as $td){
                        ...
                        if($step == 1){
                            ...
                            $header = trim($td->innertext,'&nbsp;');
                            $step++;
                        }else if ($step == 3){
                            $name .= $header.' '.trim($td->innertext,'&nbsp;');
                            $step++;
                        }else if ($step == 4){
...
class CParAlmaSTRyazan extends CParAlmaST{
    function __construct(){
        parent::__construct();
        $this->price_id = 10510609;
    }
}