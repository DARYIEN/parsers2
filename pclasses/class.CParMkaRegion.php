...
class CParMkaRegion extends CParMain{
    var $city_id;
    static $name_parser = array(
        'mkaregion' => 'МКА Регион'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://mka-region.ru/prodazha-metalloprokata.html');
        $link = $parse->find('div.pagetext span span a', 0);
        return $link->href;
    }
}