 ...
 * Time: 12:44
 */
class CParSibMetallComl extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    var $company_name;
    public $temp = array();
    public $stringForFind = 'table.table2 tbody tr';
    static $name_parser = array(
        'sibmetalcom' => 'Сибирский металл'
    );
    function start(){
        $this->getDocument();
        $this->processParsing();
    ...
    function __construct(){
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_url = 'http://sibmetall.com.ru/price';
        $this->price_id = 11487194;
        $this->iconv = true;
    }
