...
class CParPromJBIKomplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'promjbikomplect' => 'ПРОМЖБИКОМПЛЕКТ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.promgbikomplekt.ru/upload/promgbikomplekt/price/input_file/price.xls';
