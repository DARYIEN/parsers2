...
class CParTDUralstal extends CParMain{
    var $city_id;
    static $name_parser = array(
        'tduralstal' => 'ТД Урал Сталь'
    );
    public $items = array();
    function start(){
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~', file_get_html('http://td-uralstal.ru/')->find('body',0)->innertext, $out);
        $links['main']='http://td-uralstal.ru'.$out[0][0];
       // p($out);
