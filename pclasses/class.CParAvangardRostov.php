...
class CParAvangardRostov extends CParMain{
    var $city_id;
    static $name_parser = array(
        'avangard' => 'Авангард металл '
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://avangard-metall.com/assets/files/PriceAvangard.xlsx';
