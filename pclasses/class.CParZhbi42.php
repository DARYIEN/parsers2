 ...
 * Time: 16:57
 */
class CParZhbi42 extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://zavod-42.ru/sites/zavod-42.ru/files/prays_zzhbi_01.08.2015.xls';
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($this->filter['header']  && in_array("Цена",$rows) && $this->filter['horizontal']['from']['numeric'] == $num_row){
