 ...
 * Time: 12:44
 */
class CParPattern extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    function __construct(){
        ...
        $this->home_url = 'http://www.arielmetall.ru/catalog/armatura/3PS*SP/';
    ...
    function documentParsing($path){
        ...
        $table = $parse->find('table.products_table tbody tr.td_row1,table.products_table tbody tr.td_row2');
        if(!empty($table)){
            $result = array();
            foreach($table as $tr){
                $temprorary = array();
