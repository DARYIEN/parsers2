...
class CParBologovskyArmaturnyZavod extends CParMain{
    var $city_id;
    public $file_list = array();
    static $name_parser = array(
        'bologovskyarmaturnyzavod' => 'Бологовский Арматурный завод'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://bolarm.ru/fileadmin/user_upload/pricelist.zip';
