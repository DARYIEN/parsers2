...
class CParJBIKomplekt extends CParMain{
    var $city_id;
    static $name_parser = array(
        'jbikomplekt' => 'ЖБИ-комплект'
    );
    public $items = array();
    function start(){
