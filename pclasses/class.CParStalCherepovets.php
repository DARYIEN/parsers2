...
class CParStalCherepovets extends CParMain{
    var $city_id;
    static $name_parser = array(
        'stalCherepovets' => 'Сталь Череповец'
    );
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://stal-cherepovets.ru/download/price2.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->price_id = 7676886;
    }
