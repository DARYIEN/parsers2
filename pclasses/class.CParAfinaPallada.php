...
class CParAfinaPallada extends CParMain{
    var $city_id;
    static $name_parser = array(
        'afinapallada' => 'afinapallada'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.afina-pallada.net/upload/Prays%20july%20xls(2).xls';
        ...
        foreach($this->document_list as $key => $path){
            if($key == 'main'){
                ...
                $this->filter =  array(
                    ...
                    'cost2' => 0,
                    'coef' => 1,
                    'end' => ' ТУ 5786-008-00281571-2001 п.м.',
                    'header' => true,
                    'skleyka' => false,
                    'dualheader'=>false,
                    'tree' => false,
