...
class CParSPKSamara extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spksamara' => 'СПК-Самара'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.spk.ru/price/spk-samara/_m_/38843/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267644;
        $this->author = 'Михаил';
    }
