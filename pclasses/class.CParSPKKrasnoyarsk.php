...
class CParSPKKrasnoyarsk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spkkrasnoyarsk' => 'СПК-Красноярск'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.spk.ru/price/spk-krsn/_m_/10785/_p_/file';
        $this->document_urls['setka'] = 'http://www.spk.ru/price/spk-krsn/_m_/12418/_p_/file';
        $this->document_urls['prof'] = 'http://www.spk.ru/price/spk-krsn/_m_/10786/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267652;
        $this->author = 'Михаил';
    }
