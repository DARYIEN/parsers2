...
class CParDmk extends CParMain{
    var $city_id;
    static $name_parser = array(
        'dmkhab' => 'ДМК Хабаровск'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.dmk.su/sites/default/files/prays_iyun_10.06.14.xls';
        $this->document_urls['spec'] = 'http://www.dmk.su/sites/default/files/specpredlozhenie_po_trube.xls';
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($this->filter['header']  && (count($rows) == 1 || count($rows) == 2) && $this->filter['horizontal']['from']['numeric'] == $num_row){
