...
class CParBaltMetall extends CParMain{
    var $city_id;
    static $name_parser = array(
        'baltmetall' => 'БАЛТМЕТАЛЛ'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://baltmetall.com/d/379106/d/baltmetall-price-list.xlsx';
        ...
        foreach($this->sheet as $rows){
            ...
            foreach($rows as $num_row => $row){
                if(!empty($row)){
                    ...
                    if($this->filter['header']  && (count($rows) == 1||count($rows) == 2 && strripos($rows[$this->filter['horizontal']['from']['numeric']+1],'уб')!== false) && $this->filter['horizontal']['from']['numeric'] == $num_row){
