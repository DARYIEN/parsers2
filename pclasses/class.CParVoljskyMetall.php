...
class CParVoljskyMetall extends CParMain{
    var $city_id;
    public $file_list = array();
    static $name_parser = array(
        'voljskymetall' => 'Волжский Металл'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_url = 'http://vol-met34.ru/price.zip';
