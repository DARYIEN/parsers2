...
class CParBmzmMoscow extends CParMain{
    var $city_id;
    static $name_parser = array(
        'bmzm_moscow' => 'Торговый Дом БМЗ-Москва'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.bmzm.ru/download/price.xls';
...
class CParBmzmSpb extends CParMain{
    var $city_id;
    static $name_parser = array(
        'bmzm_piter' => 'Торговый Дом БМЗ-Питер'
    );
    public $items = array();
    function start(){
        $this->getDocuments()->processParsing();
