...
class CParIntegralS extends CParMain{
    var $city_id;
    static $name_parser = array(
        'integralskazan' => 'Интеграл-С'
    );
    public $items = array();
    function start(){
...
class CParIntegralSChelny extends CParIntegralS{
    function __construct(){
        parent::__construct();
        $this->document_urls['main'] = 'http://integral-s.org/images/price.xls';
        $this->price_id = 11430327;
        $this->document_name= 'IntegralSChelny'.'_'.date('d-m-Y', time()).'_'.time().'.csv';
    }
}