...
class CParUSMetall extends CParMain{
    var $city_id;
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://us-metall.ru/upload/iblock/6f2/%D0%BF%D1%80%D0%B0%D0%B9%D1%81%2003.06.2014.xls';
        //$this->document_urls['arm'] = 'http://us-metall.ru/upload/iblock/845/%D0%9F%D1%80%D0%B0%D0%B9%D1%81%20%D0%BF%D0%BE%20%D1%82%D1%80%D1%83%D0%B1%D0%BE%D0%BF%D1%80%D0%BE%D0%B2%D0%BE%D0%B4%D0%BD%D0%BE%D0%B9%20%D0%B0%D1%80%D0%BC%D0%B0%D1%82%D1%83%D1%80%D0%B5.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267496;
        $this->author = 'Михаил';
    }
    ...
    public function getUrl(){
        preg_match_all('~href=\W\S+.xlsx{0,1}\W~ui', file_get_html('http://us-metall.ru/products/truby/')->find('body',0)->innertext, $out);
        $links['main']=$out[0][0];
        //p($out);
