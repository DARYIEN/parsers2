...
class CParSPKAstrahan extends CParMain{
    var $city_id;
    static $name_parser = array(
        'spkastrahan' => 'СПК-Астрахань'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://www.spk.ru/price/spk-astr/_m_/9425/_p_/file';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267630;
        $this->author = 'Михаил';
    }
