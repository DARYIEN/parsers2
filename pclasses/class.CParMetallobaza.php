...
class CParMetallobaza extends CParMain{
    var $city_id;
    static $name_parser = array(
        'metallobaza' => 'МЕТАЛЛОБАЗА'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['main'] = 'http://metallobaza-tlt.ru/userfiles/sitefiles/price/metal.xls';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 12267626;
        $this->author = 'Михаил';
    }
