...
class CParFitingTehcomplect extends CParMain{
    var $city_id;
    static $name_parser = array(
        'fitingtehcomplect' => 'Фитинг-техкомплект'
    );
    public $items = array();
    function start(){
    ...
    function __construct(){
        ...
        $this->document_urls['black'] = 'http://www.fittexcom.ru/?dl_id=6';
        //$this->coef = 1000;
        $this->dual_cost = false;
        $this->decimal = true;
        $this->price_id = 11487218;
    }
