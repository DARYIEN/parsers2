...
class CParBaikalit extends CParMain{
    var $city_id;
    static $name_parser = array(
        'baikalitskc' => 'Байкалит СКЦ'
    );
    public $items = array();
    ...
    public function getUrl(){
        $parse = file_get_html('http://www.baikalit-metall.ru/page/production.html');
        $link = $parse->find('div.button-right a', 0);
        return 'http://www.baikalit-metall.ru'.$link->href;
    }
}