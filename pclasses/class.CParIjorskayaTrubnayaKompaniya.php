...
class CParIjorskayaTrubnayaKompaniya extends CParMain{
    var $city_id;
    var $message = '';
    var $document_urls;
    var $home_url;
    ...
    static $name_parser = array(
        'ijorskayatrubnayakompaniya' => 'Ижорская Трубная Компания'
    );
    function start(){
        $this->getDocuments();
        $this->processParsing();
    ...
    function __construct(){
        ...
        $this->price_type = 'web';
        $this->dual_cost = true;
        $this->document_urls = array(   'http://www.itpz.ru/price/',
                                    );
        $this->home_url = current($this->document_urls);
        $this->price_id = 10112624;
        $this->iconv = true;
    }
    ...
    function documentParsing($path){
       ...
       $cell=array(
           'standart'=>array('stop_cell'=>4, 'cost_cell1'=>5, 'cost_cell2'=>10,),
       );
                ...
                foreach($table->find('tr') as $tr){
                    ...
                    foreach($tr->find('td') as $td){
                        ...
                        if($step == 1){
                            ...
                            if (!empty($td->plaintext) && is_numeric($td->plaintext))
