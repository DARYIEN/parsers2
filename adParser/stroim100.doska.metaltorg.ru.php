<?php
    ...
    require_once '../stroim100AdMainer.php';
    //require_once './inc/CreateAd.php';
    
    $url="https://doska.metaltorg.ru//?page=1&metal=1&SMDeclarDivision=-1&nearby_regions=checked&nearby_countries=checked&without_exact_fo=checked";
